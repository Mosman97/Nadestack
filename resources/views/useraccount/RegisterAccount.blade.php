                    ...
                    <!-- Start: Pretty Registration Form -->
                      <div class="row text-white register-form" style="color: rgb(255,255,255);">
                        <div class="col-md-8 offset-md-2">
                            <form class="text-white" id="registration_form" style="color: rgb(255,255,255);background-color: #333138;font-family: 'Roboto';margin-top: 50px;margin-bottom: 50px;"action="{{ route('register')}}"  method="POST">
                             @csrf
