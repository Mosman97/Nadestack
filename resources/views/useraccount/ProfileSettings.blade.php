                ...
                <div class="row text-white register-form" style="color: rgb(255,255,255);">
                    <div class="col-md-8 offset-md-2">
                        <form  method="POST" action="{{url('updateProfile')}}" class="text-white" id="profile_settings_form" style="color: rgb(255,255,255);background-color: #333138;font-family: 'Roboto';margin-top: 50px;margin-bottom: 50px;">
                            ...
                            <h2 class="text-center text-light" style="padding-top: 15px;">General Informations</h2>
                            ...
                            <div class="form-check text-center"><input class="form-check-input" style="padding-bottom: 15px" type="checkbox" id="formCheck"><label class="form-check-label" for="formCheck">I've read and accept the <a style="color: red;" href="http://www.99damage.de">terms and conditions</a></label></div>
                            @csrf
                            <div class="form-row">
