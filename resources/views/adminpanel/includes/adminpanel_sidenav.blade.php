<nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
    <div class="container-fluid d-flex flex-column p-0">
        ...
        <ul class="nav navbar-nav text-light" id="accordionSidebar">
            ...
            <li class="nav-item" role="presentation"><a class="nav-link" href="{{route('adminpanel_playerindex')}}"><i class="fas fa-user"></i><span>Players</span></a>
                <a class="nav-link" href="{{route('adminpanel_teamindex')}}"><i class="fas fa-users"></i><span>Teams</span></a></li>
