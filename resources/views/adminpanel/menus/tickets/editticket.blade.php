...
<div class="row" style="margin-top: 15px">
    <div class="col">
        <form class="nadestack_form" method="post" enctype="multipart/form-data" action="{{route("adminpanel_ticketresponse",$ticket_metadata[0]['ticket_id'])}}">
            @csrf
            ...
            <div class="form-row">
                <div class="col text-center nadestack-last-element"><button class="btn btn-danger" type="submit" style="margin-top: 10px;">Answer</button></div>
            </div>
        </form>
    </div>
</div>
