                ...
                <div id="profile_settings_form_container">
                    ...
                    <div class="row text-white register-form" style="color: rgb(255,255,255);">
                        <div class="col-md-8 offset-md-2">
                            <form class="text-white" id="profile_settings_form" style="background-color: #333138;font-family: 'Roboto';margin-top: 100px;margin-bottom: 100px;" method="post" enctype="multipart/form-data" action="#">
                                <h1 class="text-center text-light nadestack_heading_one">Nadestack Support</h1>
                                <h2 class="text-center text-light nadestack_heading_two" >Instant Support during match:</h2>
                                <a href="https://discord.gg/p7K2qwt">
                                    <svg width="40%" height="40%" id="discord_svg" style="margin: auto; display: block" name ="discord_svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 272.1">
                                ...
                                <h2 class="text-center text-light" style="padding-top: 40px; padding-bottom: 15px;">Submit Support Ticket</h2>
